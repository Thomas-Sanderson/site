...
export const eras: Era[] = [
  ...
  },
  {
    ...
    narrative: [
      ...
      "I\u2019ve been exploring what becomes possible when you treat LLMs as deterministic components inside well-scoped systems rather than as the system itself. Couve reimagines behavioral health EMR workflows from the patient and clinician experience outward. Gab is a care navigator for healthcare admissions that stays inside its rails \u2014 no hallucination, no PHI exposure. Paper Cannon is a multi-agent research synthesis pipeline with adversarial quality control built into the process, not bolted on after.",
